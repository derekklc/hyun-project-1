...
Run `npx nx serve hyun-project-1` to start the development server. Happy coding!

## Build for production

Run `npx nx build hyun-project-1` to build the application. The build artifacts are stored in the output directory (e.g. `dist/` or `build/`), ready to be deployed.
